...
CREATE DATABASE IF NOT EXISTS `102204056`;

CREATE USER IF NOT EXISTS 'cinema'@'localhost' IDENTIFIED BY 'iu-cinema';
...
INSERT INTO movie (name, cover, description, playtime, releaseDate, topCast, trailerUrl, director, genre, rating, hallId, broadcastingTimes, short_desc, price)
VALUES
